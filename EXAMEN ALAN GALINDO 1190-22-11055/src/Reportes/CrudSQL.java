...
public class CrudSQL extends ConexionSQL {
   ...
   //String sql = "INSERT INTO hospital(DPI, NOMBRE, APELLIDO, TELEFONO, DIRRECCION) VALUES('" + DPI + "','" + NOMBRE + "','" + APELLIDO + "','" + TELEFONO + "','" + DIRRECCION + "');";

   
    public void insertar(String DPI, String NOMBRE, String APELLIDO, String TELEFONO, String DIRRECCION) {
        ...
        try {
           ...
           String sql = "INSERT INTO hospital(DPI,NOMBRE, APELLIDO, TELEFONO, DIRRECION,) VALUES('" + DPI + "','" + NOMBRE + "','" + APELLIDO +  "','" + TELEFONO + "','" + DIRRECCION + "');";
  ...
  public void eliminar(String DPI, JTextField txtId2, JTextField txtNombre, JTextField txtApellido,  JTextField txtTelefono, JTextField txtDirrecion) throws SQLException {
    try {
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            ...
            Connection conexion = conectar();
            Statement st = conexion.createStatement();
            String sql = "DELETE FROM empleado WHERE DPI = '" + DPI + "';";
